...
func NewLotteryTable(id string, blockId int64, registrationStartDate time.Time, registrationEndDate time.Time, lotteryStartDate time.Time, lotteryEndDate time.Time, processEndDate time.Time, processStatus int) *LotteryTable {
	return &LotteryTable{
		ID:                    id,
		BlockId:               blockId,
...
func (m *LotteryTable) valid() (bool, error) {
